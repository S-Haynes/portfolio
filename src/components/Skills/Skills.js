    ...
    setTimeout(() => this.setState({
      ...
      >
        <Row className="mt-4">
          ...
          <Col className="d-flex justify-content-center" style={{marginTop: "-100px"}} xs="12" sm="6">
        <CardImg src={ReactLogo} style={{maxWidth: '250px'}} alt="reactlogo" className="App-logo" />
        </Col>
