              ...
              <Row>
                ...
                <Col xs="12" sm="6">
                  <p style={{ fontSize: "18px" }}>
                    Hey there! I'm Shaquille Haynes, a 25-year-old Freelance
                    Front-end Developer. I consider myself an average dude who
                    is passionate about coding & gaming. I love to create new,
                    smart applications and percieve any design problem as a
                ...
                <Col xs="12" sm="6">
                  <p style={{ fontSize: "18px" }}>
                    ...
                    but I am also experienced with backend technologies
                    including Express and MongoDB.{" "}
                    <Link to="/work">
